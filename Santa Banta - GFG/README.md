...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input :</strong> <br></span><span style="font-size: 18px;">N = 10<br>M = 6<br>g[] = {{1,2},{2,3},{3,4},{4,5},{6,7},{9,10}}
...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input :</strong> <br>N = 2<br>M = 1<br>g[] = {{1, 2}} <strong>
Output :</strong> <br>3
<strong>Explanation:
